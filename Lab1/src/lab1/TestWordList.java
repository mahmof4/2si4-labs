...
public class TestWordList {
	...
	System.out.println("*************************************************************");
        ...
        listObj1.insert(s1);
        System.out.println("Test 9 - insert new word "+s1+ " in empty list:\n"+"List:\n"+listObj1.toString());
        System.out.println("capacity="+listObj1.getCapacity());
        System.out.println("size="+listObj1.getSize());
	...
	System.out.println("*************************************************************");
        ...
        System.out.println("Test 19 - sublist from empty list (" + c3 + "," + c4 +")" );
        ...
        System.out.println("count in range(" + c3 + "," + c4 +") is: "+listObj6.countInRange(c3,c4));
        
        System.out.println("*************************************************************");
        listObj6= new WordList(words5);
        System.out.println("The following test cases (20-23) are based on the list: \n"+listObj6.toString());
        
        
        System.out.println("*************************************************************");
        //test sublist  - empty sublist from non empty list - its capacity could be any positive value
        System.out.println("Test 20 - empty sublist from non empty list (" + c1 + "," + c2 +")" );
        listObj6= new WordList(words5);
        ...
        System.out.println("capacity="+listObj7.getCapacity());
        System.out.println("size="+listObj7.getSize());
        System.out.println("count in range(" + c1 + "," + c2 +") is: "+listObj6.countInRange(c1,c2));      
        
        
        System.out.println("*************************************************************");
        //test sublist - non-empty sublist; words starting with init and fin are in list (more than one for each)
        System.out.println("Test 21 - non-empty sublist (" + c3 + "," + c4 +")" );
        listObj6= new WordList(words5);
	...
	System.out.println("*************************************************************");
        ...
        System.out.println("Test 22 - non-empty sublist (" + c7 + "," + c8 +")" );
        listObj6= new WordList(words5);
        ...
        System.out.println("capacity="+listObj7.getCapacity());
        System.out.println("size="+listObj7.getSize());
        System.out.println("count in range(" + c7 + "," + c8 +") is: "+listObj6.countInRange(c7,c8));       
        
        
        System.out.println("*************************************************************");
        //test sublist  - sublist is a prefix or suffix
        System.out.println("Test 23 - sublist is a prefix or a suffix (" + c5 + "," + c6 +")" );
        listObj6= new WordList(words5);
        ...
        System.out.println("capacity="+listObj7.getCapacity());
        System.out.println("size="+listObj7.getSize());   
        System.out.println("count in range(" + c5 + "," + c6 +") is: "+listObj6.countInRange(c5,c6));    
    }//end main
}//end class
